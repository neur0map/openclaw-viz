...
interface AppState {
  ...
  runPipeline: (file: File, onProgress: (p: IndexingProgress) => void, clusteringConfig?: ProviderConfig) => Promise<IndexingResult>;
  ...
  loadSnapshot: (path: string, onProgress: (p: IndexingProgress) => void) => Promise<IndexingResult | null>;
...
export const AppStateProvider = ({ children }: { children: ReactNode }) => {
  ...
  }, [chatMessages, isAgentReady, initializeAgent, resolveFilePath, findFileNodeId, addCodeReference, resetCodeRefs, resetToolHighlights, graph, embeddingStatus, ensureWorker]);
